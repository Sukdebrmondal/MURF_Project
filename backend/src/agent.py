...
# #         if not path.exists():
# #             if configured:
# #                 # User explicitly configured a path -> surface the error
# #                 raise FileNotFoundError(f"Tutor content file not found: {path}")
# #             logger.warning(
# #                 "Tutor content file not found at %s; using built-in fallback content.", path
# #             )
# #             fallback = [
# #                 TutorConcept(
# #                     id="c1",
# #                     title="Sample Concept",
# #                     summary="This is a sample concept used when the content file is missing.",
# #                     sample_question="Explain the sample concept in one sentence.",
# #                     teach_back_prompt="Teach the sample concept back to me.",
# #                 )
# #             ]
# #             return cls(fallback)
...
# # def _fallback_content() -> TutorContentLibrary:
# #     return TutorContentLibrary(
# #         [
# #             TutorConcept(
# #                 id="c1",
# #                 title="Sample Concept",
# #                 summary="Fallback concept loaded due to missing file.",
# #                 sample_question="What is the fallback concept?",
# #                 teach_back_prompt="Explain the fallback concept back to me.",
# #             )
# #         ]
# #     )
...
# #     except Exception as exc:
# #         logger.error(
# #             "Failed to load tutor content during prewarm: %s. Using fallback content.", exc
# #         )
# #         proc.userdata["tutor_content"] = _fallback_content()
...
# #     try:
# #         content = ctx.proc.userdata.get("tutor_content")
# #         if content is None:
# #             content = TutorContentLibrary.from_env()
# #     except Exception as exc:
# #         logger.error("Failed to load tutor content at entrypoint: %s. Using fallback content.", exc)
